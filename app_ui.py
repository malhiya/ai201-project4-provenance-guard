...
with gr.Blocks(title="Provenance Guard Dashboard") as demo:
    ...
    with gr.Tabs():
        ...
        with gr.TabItem("✍️ Work Evaluation"):
            ...
            with gr.Row():
                ...
                with gr.Column(scale=1):
                    ...
                    trigger_appeal_btn = gr.Button("⚖️ Dispute This Result", variant="secondary", visible=False)
        ...
        with gr.TabItem("📋 My Submission History"):
            ...
            gr.Markdown("Look up all historical forensic submissions associated with your creator identity handle below.")
            
            with gr.Row():
                search_creator_id = gr.Textbox(
                    label="Enter Your Creator Handle to Sync Logs", 
                    placeholder="e.g., author-44",
                    value="creator-44"
                )
                search_btn = gr.Button("🔎 Sync History Rows", variant="secondary")
